# Operator Quickstart — cloud-itonami-isic-855

Shortest path from clone to a verified local dry-run for **ISIC 855** (`cloud-itonami-isic-855`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-855.git
cd cloud-itonami-isic-855
```
...
- Likely source path: `testadmn.governor.cljc`
